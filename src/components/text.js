...
export const MAIN_TITLE = "I'm Devin Kott, a computer scientist from Rochester, New York"
export const MAIN_OBJECTIVE = [
    "I'm finishing up my last year at R.I.T. and will graduate with a B.S. and M.S. in Computer Science in May 2021.",
    "My goal in my career is to get started learning about modern technologies that cross with my interests: drones, self-driving cars, space travel, and automation systems to name a few.",
